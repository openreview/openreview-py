...
class TestJournal():
    ...
    def journal(self):
        ...
        journal=Journal(fabian_client, venue_id, '1234', contact_info='tmlr@jmlr.org', full_name='Transactions of Machine Learning Research', short_name='TMLR', website='jmlr.org/tmlr')
        return journal
    ...
    def test_setup(self, openreview_client, helpers):
        ...
        journal=Journal(openreview_client, venue_id, '1234', contact_info='tmlr@jmlr.org', full_name='Transactions of Machine Learning Research', short_name='TMLR', website='jmlr.org/tmlr')
...
'''
        ...
        updated_submission_note_1 = test_client.post_note_edit(invitation='.TMLR/Paper1/-/Revision',
            ...
            note=Note(
                ...
                content={
                    ...
                    'authorids': { 'value': ['~SomeFirstName_User1', 'andrewmc@mailfour.com']},
        ...
        author_group=openreview_client.get_group(f"{venue_id}/Paper1/Authors")
        assert author_group
        assert author_group.members == ['~SomeFirstName_User1', 'andrewmc@mailfour.com']
