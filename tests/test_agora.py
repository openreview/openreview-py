...
class TestAgora():
    ...
    def test_post_submission(self, client, helpers):
        ...
        assert 'Title: Paper title<br>Your submission will be examined by the Editor-in-Chief of the venue and you will receive an email with their response shortly.<br>To your submission can be viewed on OpenReview here:' in text
