...
class TestWorkshopV2():
    ...
    def test_setup_matching(self, client, openreview_client, helpers):
        ...
        pc_client_v2.add_members_to_group('PRL/2023/ICAPS/Reviewers', ['reviewer1@icaps.cc', 'reviewer2@icaps.cc', 'reviewer3@icaps.cc', 'reviewer4@icaps.cc', 'reviewer5@icaps.cc', 'reviewer6@icaps.cc'], flush_members_cache=True)
