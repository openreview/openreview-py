...
class TestICMLConference():
    ...
    def test_create_conference(self, client, openreview_client, helpers):
        ...
        conference_request_edit = pc_client.post_note_edit(invitation='openreview.net/-/Venue_Configuration_Request',
            ...
            note=openreview.api.Note(
                content={
                    ...
                    'abbreviated_venue_name': { 'value': 'ICML 2024' },
                    'venue_website_url': { 'value': 'https://icml.cc' },
                    'location': { 'value': 'Vienna, Austria' },
                    'venue_start_date': { 'value': now.strftime('%Y/%m/%d') },
                    'program_chair_emails': { 'value': ['pc@icml.cc'] },
                    ...
                    'ethics_chairs_and_reviewers': { 'value': 'Yes, our venue has Ethics Chairs and Reviewers' },
        ...
        helpers.await_queue_edit(openreview_client, edit_id=conference_request_edit['id'])        

        request = openreview_client.get_note(conference_request_edit['note']['id'])
        
        edit = openreview_client.post_note_edit(invitation=f'openreview.net/Venue_Configuration_Request{request.number}/-/Deploy',
            signatures=[support_group_id],
            note=openreview.api.Note(
                id=request.id,
                content={
                    'venue_id': { 'value': 'ICML.cc/2024/Conference' }
                }
            ))
        
        helpers.await_queue_edit(openreview_client, edit_id=edit['id'])

        assert openreview_client.get_group('ICML.cc/2024/Conference')
        assert openreview_client.get_group('ICML.cc/2024/Conference/Senior_Area_Chairs')
        assert openreview_client.get_group('ICML.cc/2024/Conference/Area_Chairs')
        assert openreview_client.get_group('ICML.cc/2024/Conference/Reviewers')
        assert openreview_client.get_group('ICML.cc/2024/Conference/Authors')

        submission_invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/-/Submission')
        assert submission_invitation
        assert submission_invitation.duedate

        # assert openreview_client.get_invitation('ICML.cc/2024/Conference/Reviewers/-/Expertise_Selection')
        # assert openreview_client.get_invitation('ICML.cc/2024/Conference/Area_Chairs/-/Expertise_Selection')
        # assert openreview_client.get_invitation('ICML.cc/2024/Conference/Senior_Area_Chairs/-/Expertise_Selection')
...
#         domain = openreview_client.get_group('ICML.cc/2024/Conference')
...
#         group_content = openreview_client.get_group('ICML.cc/2024/Conference').content
...
#         assert group.readers == ['ICML.cc/2024/Conference', 'ICML.cc/2024/Conference/Senior_Area_Chairs/Invited']
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Senior_Area_Chairs/-/Recruitment', count=2)

#         messages = openreview_client.get_messages(subject='[ICML 2023] Senior Area Chair Invitation accepted')
#         assert len(messages) == 2

#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Senior_Area_Chairs').members) == 2
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Senior_Area_Chairs/Invited').members) == 2
...
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Area_Chairs').members) == 0
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Area_Chairs/Invited').members) == 2
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Area_Chairs/-/Recruitment', count=2)

#         messages = openreview_client.get_messages(subject='[ICML 2023] Area Chair Invitation accepted')
#         assert len(messages) == 2

#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Area_Chairs').members) == 2
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Area_Chairs/Invited').members) == 2
...
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers').members) == 0
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers/Invited').members) == 6
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers/Declined').members) == 0
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Recruitment', count=12)

#         messages = openreview_client.get_messages(subject='[ICML 2023] Reviewer Invitation accepted with reduced load')
#         assert len(messages) == 6

#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers').members) == 6
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers/Invited').members) == 6
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers/Declined').members) == 0
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Recruitment', count=13)

#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers').members) == 5
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers/Invited').members) == 6
#         assert len(openreview_client.get_group('ICML.cc/2024/Conference/Reviewers/Declined').members) == 1

#         reviewer_client = openreview.api.OpenReviewClient(username='reviewer1@icml.cc', password=helpers.strong_password)

#         request_page(selenium, "http://localhost:3030/group?id=ICML.cc/2024/Conference/Reviewers", reviewer_client.token, wait_for_element='header')
...
#         request_page(selenium, 'http://localhost:3030/group?id=ICML.cc/2024/Conference/Senior_Area_Chairs', sac_client.token, by=By.CLASS_NAME, wait_for_element='tabs-container')
...
#         registration_forum = sac_client.get_notes(invitation='ICML.cc/2024/Conference/Senior_Area_Chairs/-/Registration_Form')
#         assert len(registration_forum) == 1

#         sac_client.post_note_edit(invitation='ICML.cc/2024/Conference/Senior_Area_Chairs/-/Registration',
#                 signatures=['~SAC_ICMLOne1'],
#                 note=openreview.api.Note(
#                     content = {
...
#         invitation = ac_client.get_invitation('ICML.cc/2024/Conference/Area_Chairs/-/Registration')
...
#         invitation = reviewer_client.get_invitation('ICML.cc/2024/Conference/Reviewers/-/Registration')
#         assert 'statement' in invitation.edit['note']['content']
...
#             test_client.post_note_edit(invitation='ICML.cc/2024/Conference/-/Submission',
#                 signatures=['~SomeFirstName_User1'],
#                 note=note)

#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/-/Submission', count=101)

#         submissions = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', sort='number:asc')
#         assert len(submissions) == 101
#         assert ['ICML.cc/2024/Conference', '~SomeFirstName_User1', 'peter@mail.com', 'andrew@amazon.com', '~SAC_ICMLOne1'] == submissions[0].readers
#         assert ['~SomeFirstName_User1', 'peter@mail.com', 'andrew@amazon.com', '~SAC_ICMLOne1'] == submissions[0].content['authorids']['value']

#         authors_group = openreview_client.get_group(id='ICML.cc/2024/Conference/Authors')

#         for i in range(1,102):
#             assert f'ICML.cc/2024/Conference/Submission{i}/Authors' in authors_group.members
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/-/Submission', count=102)

#         authors_group = openreview_client.get_group(id='ICML.cc/2024/Conference/Authors')

#         assert f'ICML.cc/2024/Conference/Submission1/Authors' not in authors_group.members
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/-/Submission', count=103)
...
#         pc_client_v2=openreview.api.OpenReviewClient(username='pc@icml.cc', password=helpers.strong_password)
#         submission_invitation = pc_client_v2.get_invitation('ICML.cc/2024/Conference/-/Submission')
#         assert submission_invitation.expdate < openreview.tools.datetime_millis(now)

#         assert len(pc_client_v2.get_all_invitations(invitation='ICML.cc/2024/Conference/-/Withdrawal')) == 101
#         withdrawal_inv = pc_client_v2.get_invitation('ICML.cc/2024/Conference/Submission1/-/Withdrawal')
#         assert withdrawal_inv.expdate == openreview.tools.datetime_millis(exp_date.replace(hour=0, minute=0, second=0, microsecond=0))
#         assert len(pc_client_v2.get_all_invitations(invitation='ICML.cc/2024/Conference/-/Desk_Rejection')) == 101
#         desk_reject_inv = pc_client_v2.get_invitation('ICML.cc/2024/Conference/Submission1/-/Desk_Rejection')
...
#         assert pc_client_v2.get_invitation('ICML.cc/2024/Conference/-/PC_Revision')
...
#         ac_client = openreview.api.OpenReviewClient(username = 'ac1@icml.cc', password=helpers.strong_password)
#         submissions = ac_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', sort='number:asc')
#         assert len(submissions) == 101
#         assert ['ICML.cc/2024/Conference',
#         'ICML.cc/2024/Conference/Senior_Area_Chairs',
#         'ICML.cc/2024/Conference/Area_Chairs',
#         'ICML.cc/2024/Conference/Submission1/Authors'] == submissions[0].readers
#         assert ['ICML.cc/2024/Conference',
#         'ICML.cc/2024/Conference/Submission1/Authors'] == submissions[0].writers
#         assert ['ICML.cc/2024/Conference/Submission1/Authors'] == submissions[0].signatures
...
#         desk_reject_note = pc_openreview_client.post_note_edit(invitation=f'ICML.cc/2024/Conference/Submission{submission.number}/-/Desk_Rejection',
#                                     signatures=['ICML.cc/2024/Conference/Program_Chairs'],
#                                     note=openreview.api.Note(
#                                         content={
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/-/Desk_Rejected_Submission')

#         note = pc_openreview_client.get_note(desk_reject_note['note']['forum'])
#         assert note
#         assert note.invitations == ['ICML.cc/2024/Conference/-/Submission', 'ICML.cc/2024/Conference/-/Post_Submission', 'ICML.cc/2024/Conference/-/Desk_Rejected_Submission']

#         assert desk_reject_note['readers'] == [
#             "ICML.cc/2024/Conference/Program_Chairs",
#             f"ICML.cc/2024/Conference/Submission{submission.number}/Senior_Area_Chairs",
#             f"ICML.cc/2024/Conference/Submission{submission.number}/Area_Chairs",
#             f"ICML.cc/2024/Conference/Submission{submission.number}/Reviewers",
#             f"ICML.cc/2024/Conference/Submission{submission.number}/Authors"
#         ]

#         # reverse desk-rejection and withdraw paper
#         desk_rejection_reversion_note = openreview_client.post_note_edit(invitation=f'ICML.cc/2024/Conference/Submission{submission.number}/-/Desk_Rejection_Reversion',
#                                     signatures=['ICML.cc/2024/Conference/Program_Chairs'],
#                                     note=openreview.api.Note(
#                                         content={
...
#         withdrawal_note = pc_openreview_client.post_note_edit(invitation=f'ICML.cc/2024/Conference/Submission{submission.number}/-/Withdrawal',
#                                     signatures=[f'ICML.cc/2024/Conference/Submission{submission.number}/Authors'],
#                                     note=openreview.api.Note(
#                                         content={
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/-/Withdrawn_Submission')

#         withdrawn_submission = openreview_client.get_note(withdrawal_note['note']['forum'])
#         assert withdrawn_submission.readers == ['ICML.cc/2024/Conference/Program_Chairs',
#         'ICML.cc/2024/Conference/Submission101/Senior_Area_Chairs',
#         'ICML.cc/2024/Conference/Submission101/Area_Chairs',
#         'ICML.cc/2024/Conference/Submission101/Reviewers',
#         'ICML.cc/2024/Conference/Submission101/Authors']
...
#         'ICML.cc/2024/Conference/Senior_Area_Chairs',
#         'ICML.cc/2024/Conference/Area_Chairs',
#         'ICML.cc/2024/Conference/Reviewers',
#         'ICML.cc/2024/Conference/Submission1/Authors'] == submissions[0].readers
#         assert ['ICML.cc/2024/Conference',
#         'ICML.cc/2024/Conference/Submission1/Authors'] == submissions[0].writers
#         assert ['ICML.cc/2024/Conference/Submission1/Authors'] == submissions[0].signatures
...
#         assert client.get_group('ICML.cc/2024/Conference/Submission1/Reviewers')
#         assert client.get_group('ICML.cc/2024/Conference/Submission1/Area_Chairs')
#         assert client.get_group('ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs')

#         active_venues = pc_client.get_group('active_venues')
#         assert 'ICML.cc/2024/Conference' in active_venues.members

#         ## try to edit a submission as a PC
#         submissions = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', sort='number:asc')
#         submission = submissions[0]
#         edit_note = pc_client_v2.post_note_edit(invitation='ICML.cc/2024/Conference/-/PC_Revision',
#             signatures=['ICML.cc/2024/Conference/Program_Chairs'],
#             note=openreview.api.Note(
#                 id = submission.id,
#                 content = {
...
#         'ICML.cc/2024/Conference/Area_Chairs',
#         'ICML.cc/2024/Conference/Reviewers',
#         'ICML.cc/2024/Conference/Submission1/Authors'] == submission.readers
#         assert ['ICML.cc/2024/Conference',
#         'ICML.cc/2024/Conference/Submission1/Authors'] == submission.writers
#         assert ['ICML.cc/2024/Conference/Submission1/Authors'] == submission.signatures
...
#         author_group = pc_client_v2.get_group('ICML.cc/2024/Conference/Submission1/Authors')
...
#                     'matching_group': 'ICML.cc/2024/Conference/Area_Chairs',
...
#         openreview.tools.replace_members_with_ids(openreview_client, openreview_client.get_group('ICML.cc/2024/Conference/Senior_Area_Chairs'))

#         with open(os.path.join(os.path.dirname(__file__), 'data/rev_scores_venue.csv'), 'w') as file_handle:
#             writer = csv.writer(file_handle)
#             for sac in openreview_client.get_group('ICML.cc/2024/Conference/Senior_Area_Chairs').members:
#                 for ac in openreview_client.get_group('ICML.cc/2024/Conference/Area_Chairs').members:
...
#                 content={
#                     'title': 'Paper Matching Setup',
#                     'matching_group': 'ICML.cc/2024/Conference/Senior_Area_Chairs',
...
#         assert pc_client_v2.get_edges_count(invitation='ICML.cc/2024/Conference/Senior_Area_Chairs/-/Affinity_Score') == 4

#         openreview_client.post_edge(openreview.api.Edge(
#             invitation = 'ICML.cc/2024/Conference/Senior_Area_Chairs/-/Proposed_Assignment',
#             head = '~AC_ICMLOne1',
#             tail = '~SAC_ICMLOne1',
#             signatures = ['ICML.cc/2024/Conference/Program_Chairs'],
#             weight = 1,
...
#         venue.set_assignments(assignment_title='sac-matching', committee_id='ICML.cc/2024/Conference/Senior_Area_Chairs')

#         sac_assignment_count = pc_client_v2.get_edges_count(invitation='ICML.cc/2024/Conference/Senior_Area_Chairs/-/Assignment')
#         assert sac_assignment_count == 2

#         submissions = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', sort='number:asc')

#         openreview.tools.replace_members_with_ids(openreview_client, openreview_client.get_group('ICML.cc/2024/Conference/Area_Chairs'))
...
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Area_Chairs/-/Conflict')
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Area_Chairs/-/Affinity_Score')

#         affinity_score_count =  openreview_client.get_edges_count(invitation='ICML.cc/2024/Conference/Area_Chairs/-/Affinity_Score')
#         assert affinity_score_count == 100 * 2 ## submissions * ACs
#         assert pc_client_v2.get_edges_count(invitation='ICML.cc/2024/Conference/Area_Chairs/-/Conflict') == 200 ## assigned SAC is an author of paper 1

#         openreview.tools.replace_members_with_ids(openreview_client, openreview_client.get_group('ICML.cc/2024/Conference/Reviewers'))

#         with open(os.path.join(os.path.dirname(__file__), 'data/rev_scores_venue.csv'), 'w') as file_handle:
#             writer = csv.writer(file_handle)
#             for submission in submissions:
#                 for ac in openreview_client.get_group('ICML.cc/2024/Conference/Reviewers').members:
#                     writer.writerow([submission.id, ac, round(random.random(), 2)])
...
#             content={
#                 'title': 'Paper Matching Setup',
#                 'matching_group': 'ICML.cc/2024/Conference/Reviewers',
#                 'compute_conflicts': 'NeurIPS',
#                 'compute_conflicts_N_years': '3',
#                 'compute_affinity_scores': 'No',
#                 'upload_affinity_scores': affinity_scores_url
...
#         rev_matching_notes = [note for note in matching_notes if note.content['matching_group'] == 'ICML.cc/2024/Conference/Reviewers']
#         assert len(rev_matching_notes) == 1

#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Reviewers/-/Conflict')

#         assert openreview_client.get_edges_count(invitation='ICML.cc/2024/Conference/Reviewers/-/Conflict') == 0

#         affinity_scores =  openreview_client.get_grouped_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Affinity_Score', groupby='id')
...
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Area_Chairs/-/Bid')
#         assert invitation.edit['tail']['param']['options']['group'] == 'ICML.cc/2024/Conference/Area_Chairs'
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Reviewers/-/Bid')
#         assert invitation.edit['tail']['param']['options']['group'] == 'ICML.cc/2024/Conference/Reviewers'
...
#         request_form=pc_client.get_notes(invitation='openreview.net/Support/-/Request_Form')[0]
#         venue = openreview.helpers.get_conference(pc_client, request_form.id, setup=False)
#         submissions = pc_client_v2.get_notes(content= { 'venueid': 'ICML.cc/2024/Conference/Submission'}, sort='number:asc')
...
#                     invitation = 'ICML.cc/2024/Conference/Reviewers/-/Proposed_Assignment',
#                     head = submissions[i].id,
#                     tail = r,
#                     signatures = ['ICML.cc/2024/Conference/Program_Chairs'],
#                     weight = 1,
#                     label = 'reviewer-matching',
#                     readers = ["ICML.cc/2024/Conference", f"ICML.cc/2024/Conference/Submission{submissions[i].number}/Senior_Area_Chairs", f"ICML.cc/2024/Conference/Submission{submissions[i].number}/Area_Chairs", r],
#                     nonreaders = [f"ICML.cc/2024/Conference/Submission{submissions[i].number}/Authors"],
#                     writers = ["ICML.cc/2024/Conference", f"ICML.cc/2024/Conference/Submission{submissions[i].number}/Senior_Area_Chairs", f"ICML.cc/2024/Conference/Submission{submissions[i].number}/Area_Chairs"]
#                 ))

#             openreview_client.post_edge(openreview.api.Edge(
#                 invitation = 'ICML.cc/2024/Conference/Area_Chairs/-/Proposed_Assignment',
#                 head = submissions[i].id,
#                 tail = '~AC_ICMLOne1',
#                 signatures = ['ICML.cc/2024/Conference/Program_Chairs'],
#                 weight = 1,
...
#         venue.set_assignments(assignment_title='ac-matching', committee_id='ICML.cc/2024/Conference/Area_Chairs')

#         ac_group = pc_client_v2.get_group('ICML.cc/2024/Conference/Submission1/Area_Chairs')
#         assert ['~AC_ICMLOne1'] == ac_group.members

#         ac_group = pc_client_v2.get_group('ICML.cc/2024/Conference/Submission100/Area_Chairs')
#         assert ['~AC_ICMLTwo1'] == ac_group.members

#         sac_group = pc_client_v2.get_group('ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs')
#         assert ['~SAC_ICMLOne1'] == sac_group.members

#         sac_group = pc_client_v2.get_group('ICML.cc/2024/Conference/Submission100/Senior_Area_Chairs')
#         assert ['~SAC_ICMLOne1'] == sac_group.members

#         assignment_edges = pc_client_v2.get_edges(invitation='ICML.cc/2024/Conference/Area_Chairs/-/Assignment', head=submissions[0].id, tail='~AC_ICMLOne1')
...
#         now = datetime.datetime.utcnow()
#         due_date = now + datetime.timedelta(days=3)
#         venue.setup_assignment_recruitment(committee_id='ICML.cc/2024/Conference/Reviewers', assignment_title='reviewer-matching', hash_seed='1234', due_date=due_date)

#         venue_group = pc_client_v2.get_group('ICML.cc/2024/Conference')
#         'NeurIPS' == venue_group.content['reviewers_conflict_policy']['value']

#         pc_client_v2.post_group_edit(invitation='ICML.cc/2024/Conference/-/Edit',
#             readers = ['ICML.cc/2024/Conference'],
#             writers = ['ICML.cc/2024/Conference'],
#             signatures = ['ICML.cc/2024/Conference'],
#             group = openreview.api.Group(
...
#             ac_client.post_edge(
#                 openreview.api.Edge(invitation='ICML.cc/2024/Conference/Reviewers/-/Proposed_Assignment',
...
#             ac_client.post_edge(
#                 openreview.api.Edge(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment',
#                     signatures=[anon_group_id],
#                     head=submissions[0].id,
...
#         invite_edge=ac_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='~Emilia_ICML1')[0]
...
#         assert openreview_client.get_groups('ICML.cc/2024/Conference/Submission1/External_Reviewers/Invited', member='melisa@icml.cc')
#         assert openreview_client.get_groups('ICML.cc/2024/Conference/External_Reviewers/Invited', member='melisa@icml.cc')

#         assert not openreview_client.get_groups('ICML.cc/2024/Conference/Submission1/External_Reviewers', member='melisa@icml.cc')
#         assert not openreview_client.get_groups('ICML.cc/2024/Conference/External_Reviewers', member='melisa@icml.cc')
#         assert not openreview_client.get_groups('ICML.cc/2024/Conference/Reviewers', member='melisa@icml.cc')
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Proposed_Assignment_Recruitment')

#         ## External reviewer is set pending profile creation
#         invite_edges=pc_client_v2.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='melisa@icml.cc')
#         assert len(invite_edges) == 1
#         assert invite_edges[0].label == 'Pending Sign Up'

#         assignment_edges=pc_client_v2.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Proposed_Assignment', label='reviewer-matching', head=submissions[0].id)
...
#             invite_edge=pc_client_v2.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='melisa@icml.cc')[0]
#             invite_edge.ddate = openreview.tools.datetime_millis(datetime.datetime.utcnow())
...
#         invite_edges=pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='melisa@icml.cc')
#         assert len(invite_edges) == 0

#         invite_edges=pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='~Melisa_ICML1')
#         assert len(invite_edges) == 1
#         assert invite_edges[0].label == 'Accepted'

#         assignment_edges=pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Proposed_Assignment', label='reviewer-matching', head=submissions[0].id)
...
#         assert openreview_client.get_groups('ICML.cc/2024/Conference/Submission1/External_Reviewers', member='melisa@icml.cc')
#         assert openreview_client.get_groups('ICML.cc/2024/Conference/External_Reviewers', member='melisa@icml.cc')
#         assert not openreview_client.get_groups('ICML.cc/2024/Conference/Reviewers', member='melisa@icml.cc')

#         venue.set_assignments(assignment_title='reviewer-matching', committee_id='ICML.cc/2024/Conference/Reviewers', enable_reviewer_reassignment=True)
...
#         proposed_recruitment_inv = openreview_client.get_invitation('ICML.cc/2024/Conference/Reviewers/-/Proposed_Assignment_Recruitment')
...
#         invite_edges=pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='~Javier_ICML1')
#         assert len(invite_edges) == 1
...
#         reviewers_group = pc_client_v2.get_group('ICML.cc/2024/Conference/Submission1/Reviewers')
...
#         reviewers_group = pc_client_v2.get_group('ICML.cc/2024/Conference/Submission100/Reviewers')
#         assert len(reviewers_group.members) == 3
#         assert '~Reviewer_ICMLOne1' in reviewers_group.members
#         assert '~Reviewer_ICMLTwo1' in reviewers_group.members
#         assert '~Reviewer_ICMLFive1' in reviewers_group.members

#         assert pc_client_v2.get_invitation('ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment')

#         ## Change assigned SAC
#         assignment_edge = pc_client_v2.get_edges(invitation='ICML.cc/2024/Conference/Senior_Area_Chairs/-/Assignment', head='~AC_ICMLTwo1', tail='~SAC_ICMLOne1')[0]
#         assignment_edge.ddate = openreview.tools.datetime_millis(datetime.datetime.utcnow())
#         assignment_edge.cdate = None
...
#             invitation = 'ICML.cc/2024/Conference/Senior_Area_Chairs/-/Assignment',
#             head = '~AC_ICMLTwo1',
#             tail = '~SAC_ICMLTwo1',
#             signatures = ['ICML.cc/2024/Conference/Program_Chairs'],
#             weight = 1
...
#             invitation = 'ICML.cc/2024/Conference/Area_Chairs/-/Assignment',
#             head = submissions[0].id,
#             tail = '~AC_ICMLTwo1',
#             signatures = ['ICML.cc/2024/Conference/Program_Chairs'],
#             weight = 1
...
#         assignment_edge = pc_client_v2.get_edges(invitation='ICML.cc/2024/Conference/Area_Chairs/-/Assignment', head=submissions[0].id, tail='~AC_ICMLOne1')[0]
#         assignment_edge.ddate = openreview.tools.datetime_millis(datetime.datetime.utcnow())
#         assignment_edge.cdate = None
#         edge = pc_client_v2.post_edge(assignment_edge)
...
#         pc_client.post_group_edit(invitation='ICML.cc/2024/Conference/-/Edit',
#             readers = ['ICML.cc/2024/Conference'],
#             writers = ['ICML.cc/2024/Conference'],
#             signatures = ['ICML.cc/2024/Conference'],
#             group = openreview.api.Group(
...
#         submissions = ac_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', sort='number:asc')
#         anon_group_id = ac_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Area_Chair_', signatory='~AC_ICMLTwo1')[0].id
...
#         assert openreview_client.get_groups('ICML.cc/2024/Conference/Emergency_Reviewers/Invited', member='carlos@icml.cc')

#         assert not openreview_client.get_groups('ICML.cc/2024/Conference/Emergency_Reviewers', member='carlos@icml.cc')
#         assert not openreview_client.get_groups('ICML.cc/2024/Conference/Reviewers', member='carlos@icml.cc')
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment_Recruitment')

#         ## External reviewer is set pending profile creation
#         invite_edges=pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='carlos@icml.cc')
#         assert len(invite_edges) == 1
#         assert invite_edges[0].label == 'Pending Sign Up'
...
#         assignment_edges=pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment', head=submissions[0].id)
#         assert len(assignment_edges) == 4
...
#         invite_edges=pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='~Carlos_ICML1')
#         assert len(invite_edges) == 1
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment_Recruitment', count=2)
...
#         invite_edges=pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='~Celeste_ICML1')
#         assert len(invite_edges) == 1
#         assert invite_edges[0].label == 'Accepted'
...
# Please go to the ICML 2023 Reviewers Console and check your pending tasks: https://openreview.net/group?id=ICML.cc/2024/Conference/Reviewers
...
#         assignment_edge = pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment', head=submissions[0].id, tail='~Celeste_ICML1')[0]
#         helpers.await_queue_edit(openreview_client, edit_id=assignment_edge.id)
...
# To check all of your assigned papers, go to https://openreview.net/group?id=ICML.cc/2024/Conference/Reviewers.
...
#         assert openreview_client.get_groups('ICML.cc/2024/Conference/Emergency_Reviewers', member='celeste@icml.cc')
#         assert openreview_client.get_groups('ICML.cc/2024/Conference/Reviewers', member='celeste@icml.cc')

#         helpers.respond_invitation(selenium, request_page, invitation_url, accept=True)
#         error_message = selenium.find_element(By.CLASS_NAME, 'important_message')
#         assert 'You have already accepted this invitation.' == error_message.text

#         reviewers_group = pc_client.get_group('ICML.cc/2024/Conference/Submission1/Reviewers')
...
#         ac_group = pc_client.get_group('ICML.cc/2024/Conference/Submission1/Area_Chairs')
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment_Recruitment', count=3)
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment_Recruitment', count=4)
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment', count=2)
...
#             invite_edge=ac_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='~Reviewer_ICMLFour1')[0]
#             invite_edge.ddate = openreview.tools.datetime_millis(datetime.datetime.utcnow())
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment_Recruitment', count=5)

#         messages = openreview_client.get_messages(to='rachel_bis@icml.cc', subject='[ICML 2023] Reviewer Invitation declined for paper 1')
#         assert len(messages) == 2

#         invite_edges=openreview_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='~Rachel_ICML2')
#         assert len(invite_edges) == 1
...
#         helpers.await_queue_edit(openreview_client, invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment_Recruitment', count=6)
...
#         invite_assignment = pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Invite_Assignment', head=submissions[0].id, tail='~Ana_ICML1')[0]
...
#         assignment = pc_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment', head=submissions[10].id, tail='~Reviewer_ICMLThree1')[0]
...
#         reviewers_group = pc_client.get_group('ICML.cc/2024/Conference/Submission11/Reviewers')
#         assert len(reviewers_group.members) == 2
#         assert '~Reviewer_ICMLThree1' not in reviewers_group.members

#         assignment = pc_client.get_edges(invitation='ICML.cc/2024/Conference/Area_Chairs/-/Assignment', head=submissions[10].id, tail='~AC_ICMLOne1')[0]
#         assignment.ddate = openreview.tools.datetime_millis(datetime.datetime.utcnow())
#         assignment.cdate = None
#         edge = pc_client.post_edge(assignment)
...
#         ac_group = pc_client.get_group('ICML.cc/2024/Conference/Submission11/Area_Chairs')
#         assert [] == ac_group.members

#         sac_group = pc_client.get_group('ICML.cc/2024/Conference/Submission11/Senior_Area_Chairs')
#         assert [] == sac_group.members
...
#         assert ['ICML.cc/2024/Conference',
#         'ICML.cc/2024/Conference/Submission2/Senior_Area_Chairs',
#         'ICML.cc/2024/Conference/Submission2/Area_Chairs',
#         'ICML.cc/2024/Conference/Submission2/Reviewers',
#         'ICML.cc/2024/Conference/Submission2/Authors'] == submissions[0].readers
#         assert ['ICML.cc/2024/Conference',
#         'ICML.cc/2024/Conference/Submission2/Authors'] == submissions[0].writers
#         assert ['ICML.cc/2024/Conference/Submission2/Authors'] == submissions[0].signatures
#         assert 'authorids' not in submissions[0].content
#         assert 'authors' not in submissions[0].content
#         assert 'financial_aid'not in submissions[0].content
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Official_Review-0-1', count=1)

#         assert len(openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Official_Review')) == 50
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Official_Review')
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Official_Review-0-1', count=2)
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Position_Paper_Review-0-1', count=1)

#         assert len(openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Position_Paper_Review')) == 50
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission2/-/Official_Review')
#         assert 'review' in invitation.edit['note']['content']
#         assert 'summary' not in invitation.edit['note']['content']

#         reviewer_client = openreview.api.OpenReviewClient(username='reviewer1@icml.cc', password=helpers.strong_password)

#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Reviewer_', signatory='~Reviewer_ICMLOne1')
#         anon_group_id = anon_groups[0].id

#         review_edit = reviewer_client.post_note_edit(
#             invitation='ICML.cc/2024/Conference/Submission1/-/Official_Review',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
#                 content={
...
#         openreview_client.add_members_to_group(f'ICML.cc/2024/Conference/Submission1/Reviewers', '~Reviewer_ICMLOne1')
#         openreview_client.add_members_to_group(f'ICML.cc/2024/Conference/Submission1/Reviewers', '~Reviewer_ICMLTwo1')
#         openreview_client.add_members_to_group(f'ICML.cc/2024/Conference/Submission1/Reviewers', '~Reviewer_ICMLThree1')

#         reviewer_client_2 = openreview.api.OpenReviewClient(username='reviewer2@icml.cc', password=helpers.strong_password)
#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Reviewer_', signatory='~Reviewer_ICMLTwo1')
#         anon_group_id = anon_groups[0].id
...
#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission2/Reviewer_', signatory='~Reviewer_ICMLOne1')
#         anon_group_id = anon_groups[0].id

#         review_edit = reviewer_client.post_note_edit(
#             invitation='ICML.cc/2024/Conference/Submission2/-/Official_Review',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
#                 content={
...
#         reviews = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/Submission1/-/Official_Review', sort='number:asc')
...
#             invitations='ICML.cc/2024/Conference/-/Edit',
#             readers=['ICML.cc/2024/Conference'],
#             writers=['ICML.cc/2024/Conference'],
#             signatures=['ICML.cc/2024/Conference'],
#             invitation=openreview.api.Invitation(
#                 id='ICML.cc/2024/Conference/-/Official_Review',
#                 edit={
#                     'invitation': {
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Official_Review-0-1', count=3)

#         invitation = pc_client_v2.get_invitation('ICML.cc/2024/Conference/Submission1/-/Official_Review')
...
#             signatures=['ICML.cc/2024/Conference'],
#             invitation=openreview.api.Invitation(
#                 id='ICML.cc/2024/Conference/-/Position_Paper_Review',
#                 edit={
#                     'invitation': {
#                         'duedate': new_due_date,
#                         'expdate': new_exp_date
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Position_Paper_Review-0-1', count=2)
...
#         reviews = [reply for reply in first_submission.details['directReplies'] if f'ICML.cc/2024/Conference/Submission{first_submission.number}/-/Official_Review']

#         reviewer_client = openreview.api.OpenReviewClient(username='reviewer1@icml.cc', password=helpers.strong_password)
#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Reviewer_', signatory='~Reviewer_ICMLOne1')
#         anon_group_id = anon_groups[0].id

#         assert len(openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Rating')) == 3

#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/Official_Review1/-/Rating')
#         assert invitation.invitees == ['ICML.cc/2024/Conference/Program_Chairs', 'ICML.cc/2024/Conference/Submission1/Area_Chairs']
...
#             'ICML.cc/2024/Conference/Program_Chairs',
#             'ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs',
#             'ICML.cc/2024/Conference/Submission1/Area_Chairs'
#         ]

#         ac_client = openreview.api.OpenReviewClient(username='ac2@icml.cc', password=helpers.strong_password)
#         ac_anon_groups = ac_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Area_Chair_', signatory='~AC_ICMLTwo1')
...
#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Reviewer_', signatory='~Reviewer_ICMLTwo1')
#         anon_group_id = anon_groups[0].id
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/Official_Review2/-/Rating')
...
#         reviewer_client = openreview.api.OpenReviewClient(username='reviewer1@icml.cc', password=helpers.strong_password)
#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission3/Reviewer_', signatory='~Reviewer_ICMLOne1')
#         anon_group_id = anon_groups[0].id

#         review_edit = reviewer_client.post_note_edit(
#             invitation='ICML.cc/2024/Conference/Submission3/-/Official_Review',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
#                 content={
#                     'summary': { 'value': 'good paper' },
...
#         assert len(openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Rating')) == 4

#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission3/Official_Review1/-/Rating')
#         assert invitation.invitees == ['ICML.cc/2024/Conference/Program_Chairs', 'ICML.cc/2024/Conference/Submission3/Area_Chairs']
#         assert 'review_quality' in invitation.edit['note']['content']
#         assert invitation.edit['note']['forum'] == review_edit['note']['forum']
#         assert invitation.edit['note']['replyto'] == review_edit['note']['id']
#         assert invitation.edit['note']['readers'] == [
#             'ICML.cc/2024/Conference/Program_Chairs',
#             'ICML.cc/2024/Conference/Submission3/Area_Chairs'
#         ]
...
#         submissions = ac_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', sort='number:asc')
#         assignment = ac_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment', head=submissions[0].id, tail='~Reviewer_ICMLOne1')[0]
...
#         assignment = ac_client.get_edges(invitation='ICML.cc/2024/Conference/Reviewers/-/Assignment', head=submissions[0].id, tail='~Celeste_ICML1')[0]
#         assignment.ddate = openreview.tools.datetime_millis(datetime.datetime.utcnow())
#         assignment.signatures = [anon_group_id]
#         assignment.cdate = None
#         ac_client.post_edge(assignment)
...
#         assignment = pc_client_v2.get_edges(invitation='ICML.cc/2024/Conference/Area_Chairs/-/Assignment', head=submissions[0].id, tail='~AC_ICMLTwo1')[0]
#         assignment.ddate = openreview.tools.datetime_millis(datetime.datetime.utcnow())
#         assignment.cdate = None
...
#         assignment = pc_client_v2.get_edges(invitation='ICML.cc/2024/Conference/Area_Chairs/-/Assignment', head=submissions[0].id, tail='~AC_ICMLTwo1', trash=True)[0]
...
#         group = openreview_client.get_group('ICML.cc/2024/Conference/Ethics_Reviewers')
#         assert group
#         assert 'ICML.cc/2024/Conference/Ethics_Chairs' in group.readers
#         assert openreview_client.get_group('ICML.cc/2024/Conference/Ethics_Reviewers/Declined')
#         group = openreview_client.get_group('ICML.cc/2024/Conference/Ethics_Reviewers/Invited')
#         assert group
...
#         configuration_invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Ethics_Reviewers/-/Assignment_Configuration')
#         assert configuration_invitation.edit['note']['content']['paper_invitation']['value']['param']['default'] == 'ICML.cc/2024/Conference/-/Submission&content.venueid=ICML.cc/2024/Conference/Submission&content.flagged_for_ethics_review=true'

#         pc_client_v2=openreview.api.OpenReviewClient(username='pc@icml.cc', password=helpers.strong_password)
#         notes = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', number=[1,5])
#         for note in notes:
#             note_edit = pc_client_v2.post_note_edit(
#                 invitation='ICML.cc/2024/Conference/-/Ethics_Review_Flag',
#                 note=openreview.api.Note(
#                     id=note.id,
#                     content = {
...
#         openreview_client.add_members_to_group('ICML.cc/2024/Conference/Submission5/Ethics_Reviewers', '~Celeste_ICML1')

#         submissions = openreview_client.get_notes(content= { 'venueid': 'ICML.cc/2024/Conference/Submission'}, sort='number:asc')
...
#             'ICML.cc/2024/Conference/Ethics_Chairs',
#             'ICML.cc/2024/Conference/Submission1/Ethics_Reviewers',
#             'ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs',
#             'ICML.cc/2024/Conference/Submission1/Area_Chairs',
#             'ICML.cc/2024/Conference/Submission1/Reviewers'
#         ]
...
#             'ICML.cc/2024/Conference',
#             'ICML.cc/2024/Conference/Ethics_Chairs',
#             'ICML.cc/2024/Conference/Submission5/Ethics_Reviewers',
#             'ICML.cc/2024/Conference/Submission5/Senior_Area_Chairs',
#             'ICML.cc/2024/Conference/Submission5/Area_Chairs',
#             'ICML.cc/2024/Conference/Submission5/Reviewers'
#         ]
#         ethics_group = openreview.tools.get_group(openreview_client, 'ICML.cc/2024/Conference/Submission1/Ethics_Reviewers')
#         assert ethics_group
#         ethics_group = openreview.tools.get_group(openreview_client, 'ICML.cc/2024/Conference/Submission2/Ethics_Reviewers')
#         assert not ethics_group
#         ethics_group = openreview.tools.get_group(openreview_client, 'ICML.cc/2024/Conference/Submission5/Ethics_Reviewers')
...
#             "ICML.cc/2024/Conference/Submission1/Area_Chairs",
#             "ICML.cc/2024/Conference/Submission1/Reviewers",
#             "ICML.cc/2024/Conference/Submission1/Authors",
#             "ICML.cc/2024/Conference/Submission1/Ethics_Reviewers"
#         ]
...
#             "ICML.cc/2024/Conference/Submission2/Area_Chairs",
#             "ICML.cc/2024/Conference/Submission2/Reviewers",
#             "ICML.cc/2024/Conference/Submission2/Authors"        ]
#         assert submissions[4].readers == [
#             "ICML.cc/2024/Conference",
#             "ICML.cc/2024/Conference/Submission5/Senior_Area_Chairs",
#             "ICML.cc/2024/Conference/Submission5/Area_Chairs",
#             "ICML.cc/2024/Conference/Submission5/Reviewers",
#             "ICML.cc/2024/Conference/Submission5/Authors",
#             "ICML.cc/2024/Conference/Submission5/Ethics_Reviewers"
#         ]

#         reviews = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/Submission1/-/Official_Review')
...
#         invitations = openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Ethics_Review')
#         assert len(invitations) == 2
#         invitation = openreview_client.get_invitations(id='ICML.cc/2024/Conference/Submission1/-/Ethics_Review')[0]
#         assert invitation
#         assert 'ICML.cc/2024/Conference/Submission1/Ethics_Reviewers' in invitation.invitees
...
#         notes = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', number=[6,7,8,100])
#         for note in notes:
#             note_edit = pc_client_v2.post_note_edit(
#                 invitation='ICML.cc/2024/Conference/-/Ethics_Review_Flag',
#                 note=openreview.api.Note(
...
#         ethics_group = openreview.tools.get_group(openreview_client, 'ICML.cc/2024/Conference/Submission7/Ethics_Reviewers')
#         assert ethics_group
#         ethics_group = openreview.tools.get_group(openreview_client, 'ICML.cc/2024/Conference/Submission8/Ethics_Reviewers')
#         assert ethics_group
#         ethics_group = openreview.tools.get_group(openreview_client, 'ICML.cc/2024/Conference/Submission100/Ethics_Reviewers')
#         assert ethics_group
#         assert submissions[0].readers == [
#             "ICML.cc/2024/Conference",
#             "ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs",
...
#         assert submissions[-1].readers == [
#             "ICML.cc/2024/Conference",
#             "ICML.cc/2024/Conference/Submission100/Senior_Area_Chairs",
#             "ICML.cc/2024/Conference/Submission100/Area_Chairs",
#             "ICML.cc/2024/Conference/Submission100/Reviewers",
#             "ICML.cc/2024/Conference/Submission100/Authors",
#             "ICML.cc/2024/Conference/Submission100/Ethics_Reviewers"
#         ]
...
#         invitation = openreview_client.get_invitations(id='ICML.cc/2024/Conference/Submission100/-/Ethics_Review')[0]
#         assert invitation
#         assert 'ICML.cc/2024/Conference/Submission100/Ethics_Reviewers' in invitation.invitees

#         # use invitation to flag paper
#         pc_client_v2=openreview.api.OpenReviewClient(username='pc@icml.cc', password=helpers.strong_password)
#         note = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', number=[52])[0]
#         note_edit = pc_client_v2.post_note_edit(
#             invitation='ICML.cc/2024/Conference/-/Ethics_Review_Flag',
#             note=openreview.api.Note(
#                 id=note.id,
...
#         assert 'ICML.cc/2024/Conference/Submission52/Ethics_Reviewers' in submissions[51].readers
#         ethics_group = openreview.tools.get_group(openreview_client, 'ICML.cc/2024/Conference/Submission52/Ethics_Reviewers')
#         assert ethics_group
#         invitation = openreview_client.get_invitations(id='ICML.cc/2024/Conference/Submission52/-/Ethics_Review')[0]
#         assert invitation
#         assert 'ICML.cc/2024/Conference/Submission52/Ethics_Reviewers' in invitation.invitees

#         # comment invitations are created for all papers, with only PCs and ethics reviewers as invitees
#         invitations = openreview_client.get_all_invitations(invitation='ICML.cc/2024/Conference/-/Official_Comment')
#         assert len(invitations) == 100
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Official_Comment')
#         assert invitation.invitees == ['ICML.cc/2024/Conference', 'openreview.net/Support', 'ICML.cc/2024/Conference/Submission1/Ethics_Reviewers']

#         # post ethics review
#         openreview_client.add_members_to_group('ICML.cc/2024/Conference/Submission5/Ethics_Reviewers', '~Reviewer_ICMLOne1')
#         reviewer_client = openreview.api.OpenReviewClient(username='reviewer1@icml.cc', password=helpers.strong_password)

#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission5/Ethics_Reviewer_', signatory='~Reviewer_ICMLOne1')
#         anon_group_id = anon_groups[0].id

#         review_edit = reviewer_client.post_note_edit(
#             invitation='ICML.cc/2024/Conference/Submission5/-/Ethics_Review',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
#                 content={
#                     "recommendation": {
...
#         reviews = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/Submission5/-/Ethics_Review')
...
#         openreview_client.add_members_to_group('ICML.cc/2024/Conference/Submission5/Ethics_Reviewers', '~Reviewer_ICMLTwo1')
#         reviewer_client = openreview.api.OpenReviewClient(username='reviewer2@icml.cc', password=helpers.strong_password)
#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission5/Ethics_Reviewer_', signatory='~Reviewer_ICMLTwo1')
#         anon_group_id = anon_groups[0].id

#         with pytest.raises(openreview.OpenReviewException, match=r'The Invitation ICML.cc/2024/Conference/Submission5/-/Ethics_Review has expired'):
#             review_edit = reviewer_client.post_note_edit(
#                 invitation='ICML.cc/2024/Conference/Submission5/-/Ethics_Review',
#                 signatures=[anon_group_id],
#                 note=openreview.api.Note(
...
#         helpers.await_queue()
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Official_Comment-0-1', count=1)
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Chat-0-1', count=1)
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Chat_Reaction-0-1', count=1)

#         chat_invitations = openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Chat')
#         assert len(chat_invitations) == 100

#         chat_reaction_invitations = openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Chat_Reaction')
#         assert len(chat_reaction_invitations) == 100        
        
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Official_Comment')
#         assert invitation
#         assert 'ICML.cc/2024/Conference/Submission1/Ethics_Reviewers' in invitation.invitees
#         assert 'ICML.cc/2024/Conference/Submission1/Ethics_Reviewers' in invitation.edit['note']['readers']['param']['enum']
#         assert invitation.edit['signatures']['param']['items'] == [
#             {
#             "value": "ICML.cc/2024/Conference/Program_Chairs",
#             "optional": True
#             },
#             {
#             "value": "ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs",
#             "optional": True
#             },
#             {
#             "prefix": "ICML.cc/2024/Conference/Submission1/Area_Chair_.*",
#             "optional": True
#             },
#             {
#             "prefix": "ICML.cc/2024/Conference/Submission1/Reviewer_.*",
#             "optional": True
#             },
#             {
#             "prefix": "ICML.cc/2024/Conference/Submission1/Ethics_Reviewer_.*",
#             "optional": True
#             },
#             {
#             "value": "ICML.cc/2024/Conference/Ethics_Chairs",
#             "optional": True
#             }
#         ]
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission2/-/Official_Comment')
#         assert invitation
#         assert 'ICML.cc/2024/Conference/Submission2/Ethics_Reviewers' not in invitation.edit['note']['readers']['param']['enum']
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission3/-/Official_Comment')
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission4/-/Official_Comment')
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission5/-/Official_Comment')
#         assert invitation        
#         assert 'ICML.cc/2024/Conference/Submission5/Ethics_Reviewers' in invitation.invitees
#         assert 'ICML.cc/2024/Conference/Submission5/Ethics_Reviewers' in invitation.edit['note']['readers']['param']['enum']
...
#             },
#             {
#             "value": "ICML.cc/2024/Conference/Submission5/Senior_Area_Chairs",
#             "optional": True
#             },
#             {
#             "prefix": "ICML.cc/2024/Conference/Submission5/Area_Chair_.*",
#             "optional": True
#             },
#             {
#             "prefix": "ICML.cc/2024/Conference/Submission5/Reviewer_.*",
#             "optional": True
#             },
#             {
#             "prefix": "ICML.cc/2024/Conference/Submission5/Ethics_Reviewer_.*",
#             "optional": True
#             },
#             {
#             "value": "ICML.cc/2024/Conference/Ethics_Chairs",
...
#         pc_client_v2=openreview.api.OpenReviewClient(username='pc@icml.cc', password=helpers.strong_password)
#         # unflag a paper
#         note = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', number=[5])[0]
#         note_edit = pc_client_v2.post_note_edit(
#             invitation='ICML.cc/2024/Conference/-/Ethics_Review_Flag',
#             note=openreview.api.Note(
#                 id=note.id,
...
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission5/-/Official_Comment')
#         assert invitation        
#         assert 'ICML.cc/2024/Conference/Submission5/Ethics_Reviewers' not in invitation.invitees
#         assert 'ICML.cc/2024/Conference/Submission5/Ethics_Reviewers' in invitation.edit['note']['readers']['param']['enum']
#         assert invitation.edit['signatures']['param']['items'] == [
#             {
#             "value": "ICML.cc/2024/Conference/Program_Chairs",
...
#         invitation = openreview_client.get_invitations(id='ICML.cc/2024/Conference/Submission5/-/Ethics_Review')[0]
#         assert invitation.expdate < openreview.tools.datetime_millis(datetime.datetime.utcnow())
#         ethics_group = openreview_client.get_group('ICML.cc/2024/Conference/Submission5/Ethics_Reviewers')
#         assert ethics_group and '~Celeste_ICML1' in ethics_group.members

#         reviewer_client = openreview.api.OpenReviewClient(username='reviewer1@icml.cc', password=helpers.strong_password)

#         submissions = reviewer_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', sort='number:asc')

#         anon_groups = reviewer_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Reviewer_', signatory='~Reviewer_ICMLOne1')
#         anon_group_id = anon_groups[0].id

#         comment_edit = reviewer_client.post_note_edit(
#             invitation='ICML.cc/2024/Conference/Submission1/-/Official_Comment',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
...
#         )
#         venue.create_custom_stage()
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Author_AC_Confidential_Comment-0-1', count=1)

#         assert len(openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Author_AC_Confidential_Comment')) == 100
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Author_AC_Confidential_Comment')
...
#             invitation='ICML.cc/2024/Conference/Submission1/-/Author_AC_Confidential_Comment',
#             signatures=['ICML.cc/2024/Conference/Submission1/Authors'],
#             note=openreview.api.Note(
#                 replyto=submissions[0].id,
#                 content={
...
#         confidential_comment = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/Submission1/-/Author_AC_Confidential_Comment')[0]
...
#         ac_client = openreview.api.OpenReviewClient(username='ac2@icml.cc', password=helpers.strong_password)
#         anon_groups = ac_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Area_Chair_', signatory='~AC_ICMLTwo1')
#         anon_group_id = anon_groups[0].id
...
#                     invitees = ['ICML.cc/2024/Conference/Program_Chairs', 'openreview.net/Support'],
...
#                             'values' : ['ICML.cc/2024/Conference/Program_Chairs', 'openreview.net/Support']
#                         }
#                     },
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Official_Review-0-1', count=4)

#         pc_client_v2=openreview.api.OpenReviewClient(username='pc@icml.cc', password=helpers.strong_password)

#         # check reviews of a flagged paper is visible to ethics reviewers and authors
#         reviews = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/Submission1/-/Official_Review')
#         assert len(reviews) == 2
#         assert reviews[0].readers == [
#             'ICML.cc/2024/Conference/Program_Chairs',
#             'ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs',
#             'ICML.cc/2024/Conference/Submission1/Area_Chairs',
#             'ICML.cc/2024/Conference/Submission1/Reviewers/Submitted',
#             'ICML.cc/2024/Conference/Submission1/Authors',
#             'ICML.cc/2024/Conference/Submission1/Ethics_Reviewers',
#             reviews[0].signatures[0]
#         ]
...
#         reviews = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/Submission2/-/Official_Review')
#         assert len(reviews) == 1
#         assert reviews[0].readers == [
#             'ICML.cc/2024/Conference/Program_Chairs',
#             'ICML.cc/2024/Conference/Submission2/Senior_Area_Chairs',
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Position_Paper_Review-0-1', count=3)
...
#             'ICML.cc/2024/Conference/Submission2/Senior_Area_Chairs',
#             'ICML.cc/2024/Conference/Submission2/Area_Chairs',
#             'ICML.cc/2024/Conference/Submission2/Reviewers/Submitted',
#             'ICML.cc/2024/Conference/Submission2/Authors',
#             reviews[0].signatures[0]
#         ]
...
#         assert len(openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Rebuttal')) == 100
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Rebuttal')
...
#             invitation='ICML.cc/2024/Conference/Submission1/-/Rebuttal',
#             signatures=['ICML.cc/2024/Conference/Submission1/Authors'],
#             note=openreview.api.Note(
...
#         rebuttals = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/Submission1/-/Rebuttal')
...
#         note = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', number=[2])[0]
#         note_edit = pc_client_v2.post_note_edit(
#                 invitation='ICML.cc/2024/Conference/-/Ethics_Review_Flag',
#                 note=openreview.api.Note(
#                     id=note.id,
...
#         reviews = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/Submission2/-/Official_Review')
#         for review in reviews:
#             assert review.readers == [
#                 'ICML.cc/2024/Conference/Program_Chairs',
#                 'ICML.cc/2024/Conference/Submission2/Senior_Area_Chairs',
...
#                 'ICML.cc/2024/Conference/Submission2/Reviewers/Submitted',
#                 'ICML.cc/2024/Conference/Submission2/Authors',
#                 'ICML.cc/2024/Conference/Submission2/Ethics_Reviewers',
#                 review.signatures[0]
#             ]
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Meta_Review-0-1', count=1)

#         invitations = openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Meta_Review')
#         assert len(invitations) == 50
#         assert invitations[0].edit['note']['id']['param']['withInvitation'] == invitations[0].id

#         invitations = openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Meta_Review_SAC_Revision')
#         assert len(invitations) == 50

#         sac_revision_invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Meta_Review_SAC_Revision')
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Meta_Review')
...
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Meta_Review')
#         assert not openreview.tools.get_invitation(openreview_client, 'ICML.cc/2024/Conference/Submission2/-/Meta_Review')
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission3/-/Meta_Review')
#         assert not openreview.tools.get_invitation(openreview_client, 'ICML.cc/2024/Conference/Submission4/-/Meta_Review')
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission5/-/Meta_Review')
...
#         venue.create_meta_review_stage()
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Position_Paper_Meta_Review-0-1', count=1)

#         invitations = openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Position_Paper_Meta_Review')
#         assert len(invitations) == 50
#         assert invitations[0].edit['note']['id']['param']['withInvitation'] == invitations[0].id

#         invitations = openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Position_Paper_Meta_Review_SAC_Revision')
#         assert len(invitations) == 50

#         sac_revision_invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission2/-/Meta_Review_SAC_Revision')
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission2/-/Meta_Review')
#         assert sac_revision_invitation.edit['note']['id']['param']['withInvitation'] == invitation.id
...
#             invitation='ICML.cc/2024/Conference/Submission1/-/Meta_Review',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
#                 content={
...
#         anon_groups = ac_client.get_groups(prefix='ICML.cc/2024/Conference/Submission4/Area_Chair_', signatory='~AC_ICMLOne1')
#         anon_group_id = anon_groups[0].id

#         meta_review_edit = ac_client.post_note_edit(
#             invitation='ICML.cc/2024/Conference/Submission4/-/Meta_Review',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
#                 content={
#                     'metareview': { 'value': 'This is a good paper' },
...
#             signatures=['ICML.cc/2024/Conference'],
#             invitation=openreview.api.Invitation(
#                 id='ICML.cc/2024/Conference/-/Position_Paper_Meta_Review',
#                 edit={
#                     'invitation': {
#                         'duedate': new_due_date,
#                         'expdate': new_exp_date
...
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Position_Paper_Meta_Review-0-1', count=2)
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission4/-/Meta_Review')
#         assert invitation.expdate == new_exp_date
...
#         assert len(openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Meta_Review_Agreement')) == 2

#         sac_client = openreview.api.OpenReviewClient(username = 'sac2@icml.cc', password=helpers.strong_password)
#         submissions = sac_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', sort='number:asc')

#         ac_client = openreview.api.OpenReviewClient(username='ac2@icml.cc', password=helpers.strong_password)
#         anon_groups = ac_client.get_groups(prefix='ICML.cc/2024/Conference/Submission1/Area_Chair_', signatory='~AC_ICMLTwo1')
#         anon_group_id = anon_groups[0].id

#         invitation_id = 'ICML.cc/2024/Conference/Submission1/Meta_Review1/-/Meta_Review_Agreement'

#         agreement_edit = sac_client.post_note_edit(
#             invitation=invitation_id,
#             signatures=['ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs'],
#             note=openreview.api.Note(
#                 content={
...
#         pc_client_v2=openreview.api.OpenReviewClient(username='pc@icml.cc', password=helpers.strong_password)
#         metareviews = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/Submission1/-/Meta_Review')
...
#         anon_groups = ac_client.get_groups(prefix='ICML.cc/2024/Conference/Submission2/Area_Chair_', signatory='~AC_ICMLOne1')
#         anon_group_id = anon_groups[0].id

#         # post another metareview and check agreement invitation is created
#         meta_review_edit = ac_client.post_note_edit(
#             invitation='ICML.cc/2024/Conference/Submission2/-/Meta_Review',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
#                 content={
...
#         assert len(openreview_client.get_invitations(invitation='ICML.cc/2024/Conference/-/Meta_Review_Agreement')) == 3

#         invitation_id = 'ICML.cc/2024/Conference/Submission2/Meta_Review1/-/Meta_Review_Agreement'
#         sac_client = openreview.api.OpenReviewClient(username = 'sac1@gmail.com', password=helpers.strong_password)

#         agreement_edit = sac_client.post_note_edit(
#             invitation=invitation_id,
#             signatures=['ICML.cc/2024/Conference/Submission2/Senior_Area_Chairs'],
#             note=openreview.api.Note(
#                 content={
...
#         pc_client_v2=openreview.api.OpenReviewClient(username='pc@icml.cc', password=helpers.strong_password)
#         metareviews = pc_client_v2.get_notes(invitation='ICML.cc/2024/Conference/Submission2/-/Meta_Review')
#         agreements = pc_client_v2.get_notes(invitation=invitation_id)
#         assert agreements[0].replyto == metareviews[0].id
#         assert agreements[0].readers == [
#             'ICML.cc/2024/Conference/Program_Chairs',
...
#             invitation='ICML.cc/2024/Conference/Submission2/-/Meta_Review_SAC_Revision',
#             signatures=['ICML.cc/2024/Conference/Submission2/Senior_Area_Chairs'],
#             note=openreview.api.Note(
#                 id=metareviews[0].id,
#                 content={
...
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Decision')
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission2/-/Decision')
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission3/-/Decision')
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission4/-/Decision')
#         assert openreview_client.get_invitation('ICML.cc/2024/Conference/Submission5/-/Decision')
...
#         decision = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/Submission1/-/Decision')[0]
...
#         decision = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/Submission3/-/Decision')[0]
#         assert 'Revision Needed' == decision.content['decision']['value']

#         # manually change a decision
#         pc_client_v2=openreview.api.OpenReviewClient(username='pc@icml.cc', password=helpers.strong_password)
#         decision_note = pc_client_v2.post_note_edit(invitation='ICML.cc/2024/Conference/Submission3/-/Decision',
#             signatures=['ICML.cc/2024/Conference/Program_Chairs'],
#             note=openreview.api.Note(
#                 id=decision.id,
#                 content={
...
#         assert submissions[0].content['authors']['readers'] == ["ICML.cc/2024/Conference","ICML.cc/2024/Conference/Submission1/Authors"]
#         assert submissions[0].content['authorids']['readers'] == ["ICML.cc/2024/Conference","ICML.cc/2024/Conference/Submission1/Authors"]
#         assert submissions[1].content['authors']['readers'] == ["ICML.cc/2024/Conference","ICML.cc/2024/Conference/Submission2/Authors"]
#         assert submissions[1].content['authorids']['readers'] == ["ICML.cc/2024/Conference","ICML.cc/2024/Conference/Submission2/Authors"]
...
#         rejected_submissions = venue.get_submissions(venueid='ICML.cc/2024/Conference/Rejected_Submission', sort='number:asc')
...
#         assert 'Decision notifications have been sent to the authors. You can check the status of the emails by clicking on this link: https://openreview.net/messages?parentGroup=ICML.cc/2024/Conference/Authors' in replies[1].content['comment']
...
#             assert submission.content['venueid']['value'] == 'ICML.cc/2024/Conference'
...
#                 f"ICML.cc/2024/Conference/Submission{submission.number}/Authors"
#             ]
#             assert submission.content['authors']['readers'] == ["ICML.cc/2024/Conference",f"ICML.cc/2024/Conference/Submission{submission.number}/Authors"]
#             assert submission.content['authorids']['readers'] == ["ICML.cc/2024/Conference",f"ICML.cc/2024/Conference/Submission{submission.number}/Authors"]
#             assert not submission.pdate
#             assert not submission.odate
#             assert submission.content['venue']['value'] == 'Submitted to ICML 2023'
#             assert submission.content['venueid']['value'] == 'ICML.cc/2024/Conference/Rejected_Submission'
#             assert 'readers' in submission.content['pdf']
#             assert 'readers' not in submission.content['financial_aid']
...
#             helpers.await_queue_edit(openreview_client, invitation=f'ICML.cc/2024/Conference/Submission{number}/-/Decision')

#         authors_accepted_group = openreview_client.get_group('ICML.cc/2024/Conference/Authors/Accepted')
...
#         pub_chair_group = openreview_client.get_group('ICML.cc/2024/Conference/Publication_Chairs')
...
#         submission = openreview_client.get_notes(invitation='ICML.cc/2024/Conference/-/Submission', number=1)[0]
...
#         invitation = openreview_client.get_invitation('ICML.cc/2024/Conference/Submission1/-/Chat')
#         assert invitation.date_processes[0].get('dates') == []

#         note_edit = reviewer_client.post_note_edit(
#             invitation='ICML.cc/2024/Conference/Submission1/-/Chat',
#             signatures=[anon_group_id],
#             note=openreview.api.Note(
...
#             invitation='ICML.cc/2024/Conference/Submission1/-/Chat_Reaction',
#             signatures=['ICML.cc/2024/Conference/Submission1/Senior_Area_Chairs'],
#             tag='😄',
#             replyto=note_edit['note']['id']
#         ))

#         tags = openreview_client.get_tags(invitation='ICML.cc/2024/Conference/Submission1/-/Chat_Reaction', mintmdate=tag.tmdate - 5000)
#         assert len(tags) == 1
...
#         helpers.await_queue()
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Official_Comment-0-1', count=1)
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Chat-0-1', count=2)
#         helpers.await_queue_edit(openreview_client, 'ICML.cc/2024/Conference/-/Chat_Reaction-0-1', count=2)
