...
class TestTools():
    ...
    def test_subdomains(self):
        ...
        # e.g. "edu.cn", "ac.uk"
        assert openreview.tools.subdomains('michael@mails.tsinghua.edu.cn') == ['mails.tsinghua.edu.cn', 'tsinghua.edu.cn', 'tsinghua.edu']
        assert openreview.tools.subdomains('michael@robots.ox.ac.uk') == ['robots.ox.ac.uk', 'ox.ac.uk', 'oxford.ac.uk']
        assert openreview.tools.subdomains('michael@eng.ox.ac.uk') == ['eng.ox.ac.uk', 'ox.ac.uk', 'oxford.ac.uk']
