...
- [all invited list](https://openreview.net/group/edit?id=ABCD.cc/2025/Conference/Program_Committee/Invited)'''
        ...
        assert set(openreview_client.get_group('ABCD.cc/2025/Conference/Program_Committee/Invited').members) == {'reviewer_one@abcd.cc', 'reviewer_two@abcd.cc', 'reviewer@mail.com'}
        assert openreview_client.get_group('ABCD.cc/2025/Conference/Program_Committee/Declined').members == []
        assert openreview_client.get_group('ABCD.cc/2025/Conference/Program_Committee').members == ['reviewer_one@abcd.cc']
...
- [all invited list](https://openreview.net/group/edit?id=ABCD.cc/2025/Conference/Program_Committee/Invited)'''
    ...
    def test_reviewers_setup_matching(self, openreview_client, helpers):
        ...
        # assert len(notes) == 3
        assert notes[-1].content['title']['value'] == 'Program Committee Conflicts Computation Failed'
    ...
    def test_reviewers_deployment(self, openreview_client, helpers):
        ...
        helpers.await_queue_edit(openreview_client, invitation='openreview.net/Support/Venue_Request/Conference_Review_Workflow/-/Status', count=8)
    ...
    def test_email_reviews(self, openreview_client, helpers):
        ...
        helpers.await_queue_edit(openreview_client, invitation='openreview.net/Support/Venue_Request/Conference_Review_Workflow/-/Status', count=9)
...
'''
    ...
    def test_decision_stage(self, openreview_client, helpers):
        ...
        helpers.await_queue_edit(openreview_client, invitation='openreview.net/Support/Venue_Request/Conference_Review_Workflow/-/Status', count=11)
    ...
    def test_email_decisions(self, openreview_client, helpers):
        ...
        helpers.await_queue_edit(openreview_client, invitation='openreview.net/Support/Venue_Request/Conference_Review_Workflow/-/Status', count=13)
