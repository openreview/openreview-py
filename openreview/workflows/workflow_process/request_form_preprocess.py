def process(client, edit, invitation):
    ...
    reviewer_role_name = request_note.content.get('reviewer_role_name', request_note.content.get('reviewers_name', {})).get('value', 'Reviewers')
    area_chair_role_name = request_note.content.get('area_chair_role_name', request_note.content.get('area_chairs_name', {})).get('value', 'Area_Chairs')
    has_area_chairs = request_note.content.get('area_chairs_support', {}).get('value', False)
    if has_area_chairs and reviewer_role_name == area_chair_role_name:
