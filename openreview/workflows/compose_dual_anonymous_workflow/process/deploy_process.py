def process(client, edit, invitation):
    ...
    client.post_group_edit(
        invitation=f'{support_user}/Compose_Dual_Anonymous/Venue_Configuration_Request/-/Venue_Group_Template',
    ...
    client.post_group_edit(
        invitation=f'{support_user}/Compose_Dual_Anonymous/Venue_Configuration_Request/-/Program_Chairs_Group_Template',
        signatures=['~Super_User1'],
        content={
            'venue_id': { 'value': venue_id},
    ...
    client.post_group_edit(
        invitation=f'{support_user}/Compose_Dual_Anonymous/Venue_Configuration_Request/-/Area_Chairs_Group_Template',
        signatures=['~Super_User1'],
        content={
            'venue_id': { 'value': venue_id },
    ...
    client.post_group_edit(
        invitation=f'{support_user}/Compose_Dual_Anonymous/Venue_Configuration_Request/-/Automated_Administrator_Group_Template',
        signatures=['~Super_User1'],
        content={
            'venue_id': { 'value': venue_id }
        },
