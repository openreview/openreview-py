def process(client, invitation):
    ...
    all_profiles = openreview.tools.get_profiles(client, list(workflow_chairs_members), as_dict=True, with_preferred_emails=domain.content.get('preferred_emails_id', {}).get('value'))
