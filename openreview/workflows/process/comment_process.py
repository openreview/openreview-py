...
To view the comment, click here: https://openreview.net/forum?id={submission.id}&noteId={comment.id}'''
    ...
    if senior_area_chairs_name:
        ...
        email_SAC = ((len(comment.readers)==3 and paper_senior_area_chairs_id in comment.readers and program_chairs_id in comment.readers) or parent_invitation.get_content_value('email_senior_area_chairs', False))
