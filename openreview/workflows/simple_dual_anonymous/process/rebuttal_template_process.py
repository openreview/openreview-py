def process(client, edit, invitation):
    ...
    edit_invitations_builder.set_edit_reply_readers_invitation(rebuttal_invitation_id)
    edit_invitations_builder.set_edit_content_invitation(rebuttal_invitation_id)
    edit_invitations_builder.set_edit_email_settings_invitation(rebuttal_invitation_id, email_pcs=True, email_authors=True)