def process(client, note, invitation):
    ...
    if forum_note.content.get('api_version', '1') == '2':
        ...
        if senior_area_chairs_name and matching_group.endswith(senior_area_chairs_name) and forum_note.content.get('senior_area_chairs_assignment', 'Area_Chairs') == 'Area_Chairs':
