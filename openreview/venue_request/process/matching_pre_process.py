def process(client, note, invitation):
    ...
    if forum_note.content.get('api_version', '1') == '2':
        ...
        senior_area_chairs_assignment = forum_note.content.get('senior_area_chairs_assignment', 'Area Chairs')
        if senior_area_chairs_id and matching_group == senior_area_chairs_id and senior_area_chairs_assignment == 'Area Chairs':
        ...
        if compute_conflicts and senior_area_chairs_id and area_chairs_id and matching_group == area_chairs_id:
            ...
            if not num_edges and senior_area_chairs_assignment == 'Area Chairs':
