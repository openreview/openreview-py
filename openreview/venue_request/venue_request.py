...
class VenueRequest():
    ...
    def setup_request_form(self):
        ...
        self.request_content = {
            ...
            'venue_type': {
                'description': 'Please select the option that best describes the type of venue you\'re hosting. If neither option is appropriate, type your anwser into the text box.',
                'values-dropdown': ['Conference', 'Workshop', 'Internal review', 'Symposium', 'University course'],
                'required': False,
                'order': 5
            },
            'venue_colocation': {
                'description': 'Is your venue colocated with a larger orgaization, institution or event? For example, "This is an IEEE conference."',
                'value-regex': '.*',
                'required': False,
                'order': 6
            },
            'previous_venue': {
                'description': 'Have you used OpenReview in a previous iteration? Please share the venue id with us in the textbox. Ex, "AAAI.org/2022/Workshop/XRT"',
                'value-regex': '.*',
                'required': False,
                'order': 7
            },
