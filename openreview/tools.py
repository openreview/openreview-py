...
def concurrent_get_groups(client, **params):
    """
    Given a client and a set of parameters, returns a list of groups.

    :param client: Client used to make requests
    :type client: Client
    :param params: Parameters to pass to the client.get_groups function
    :type params: dict

    :return: List of groups
    :rtype: list
    """
    return concurrent_get(client, client.get_groups, **params)

def concurrent_get_invitations(client, **params):
    """
    Given a client and a set of parameters, returns a list of invitations.

    :param client: Client used to make requests
    :type client: Client
    :param params: Parameters to pass to the client.get_invitations function
    :type params: dict

    :return: List of invitations
    :rtype: list
    """
    return concurrent_get(client, client.get_invitations, **params)

def concurrent_get_notes(client, **params):
    """
    Given a client and a set of parameters, returns a list of notes.

    :param client: Client used to make requests
    :type client: Client
    :param params: Parameters to pass to the client.get_notes function
    :type params: dict

    :return: List of notes
    :rtype: list
    """
    return concurrent_get(client, client.get_notes, **params)

def concurrent_get_references(client, **params):
    """
    Given a client and a set of parameters, returns a list of references.

    :param client: Client used to make requests
    :type client: Client
    :param params: Parameters to pass to the client.get_references function
    :type params: dict

    :return: List of references
    :rtype: list
    """
    return concurrent_get(client, client.get_references, **params)

def concurrent_get_tags(client, **params):
    """
    Given a client and a set of parameters, returns a list of tags.

    :param client: Client used to make requests
    :type client: Client
    :param params: Parameters to pass to the client.get_tags function
    :type params: dict

    :return: List of tags
    :rtype: list
    """
    return concurrent_get(client, client.get_tags, **params)

def concurrent_get_edges(client, **params):
    """
    Given a client and a set of parameters, returns a list of edges.

    :param client: Client used to make requests
    :type client: Client
    :param params: Parameters to pass to the client.get_edges function
    :type params: dict

    :return: List of edges
    :rtype: list
    """
    return concurrent_get(client, client.get_edges, **params)
