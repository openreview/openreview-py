...
def get_profiles(client, ids_or_emails, current_institution_domain=None, with_publications=False, with_relations=False, with_preferred_emails=None, as_dict=False):
    '''
