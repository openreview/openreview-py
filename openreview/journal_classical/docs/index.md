# JMLR OpenReview Docs

This index links the workflow, role, and contributor documents used to review
JMLR OpenReview configuration changes.
...
- [Action inventory](workflow/action-inventory.md)
- [Paper page role/stage matrix](workflow/paper-page-role-stage-matrix.md)
...
- [Author console](workflow/consoles/author.md)
- [Reviewer console](workflow/consoles/reviewer.md)
- [Action Editor console](workflow/consoles/action-editor.md)
- [Editor-in-Chief console](workflow/consoles/editor-in-chief.md)
- [Production Editor console](workflow/consoles/production-editor.md)
...
- [JMLR style files](reference/jmlr-style/README.md)
