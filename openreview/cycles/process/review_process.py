def process(client, edit, invitation):
    ...
    PAPER_ACTION_EDTIORS_ID = PAPER_ACTION_EDITORS_ID.replace('{number}', str(submission.number))
...
'''
    ...
    if USE_ACTION_EDITORS and 'everyone' in review.readers or PAPER_ACTION_EDITORS_ID in review.readers:
        client.post_message(
