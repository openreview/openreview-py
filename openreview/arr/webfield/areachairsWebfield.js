...
browseInvitations.push(`${reviewerGroup}/-/Emergency_Load,head:ignore`)
browseProposedInvitations.push(`${reviewerGroup}/-/Emergency_Load,head:ignore`)

browseInvitations.push(`${reviewerGroup}/-/Emergency_Area,head:ignore`)
browseProposedInvitations.push(`${reviewerGroup}/-/Emergency_Area,head:ignore`)

browseInvitations.push(`${reviewerGroup}/-/Reviewing_Resubmissions,head:ignore`)
browseProposedInvitations.push(`${reviewerGroup}/-/Reviewing_Resubmissions,head:ignore`)

browseInvitations.push(`${reviewerGroup}/-/Author_In_Current_Cycle,head:ignore`)
browseProposedInvitations.push(`${reviewerGroup}/-/Author_In_Current_Cycle,head:ignore`)

browseInvitations.push(`${reviewerGroup}/-/Seniority,head:ignore`)
browseProposedInvitations.push(`${reviewerGroup}/-/Seniority,head:ignore`)
...
return {
  ...
  properties: {
    ...
    registrationFormDomainMap: {
      '/Area_Chairs/-/Registration': 'aclweb.org/ACL/ARR',
      '/Area_Chairs/-/Max_Load_And_Unavailability_Request': 'aclweb.org/ACL/ARR',
      '/Area_Chairs/-/License_Agreement': 'aclweb.org/ACL/ARR',
      '/Area_Chairs/-/Emergency_Metareviewer_Agreement': 'aclweb.org/ACL/ARR'
    },
  }
}
