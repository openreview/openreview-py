def process(client, edit, invitation):
    ...
    official_review_name = domain.content.get('review_name', {}).get('value')
    ...
    ae_checklist_name = 'Action_Editor_Checklist'
    reviewer_checklist_name = 'Reviewer_Checklist'
    ...
    if submission.content['flagged_for_ethics_review']['value']:
        ...
        for review_name in [official_review_name, ae_checklist_name, reviewer_checklist_name]:
