def process(client, invitation):
    ...
    latest_reference = client_v1.get_references(referent=request_form_id, invitation=f"{support_group}/-/Request{request_form.number}/Meta_Review_Stage")[0]

    latest_content = latest_reference.content
    latest_content['release_meta_reviews_to_authors'] = 'Yes, meta reviews should be revealed when they are posted to the paper\'s authors'
