...
class Venue(object):
    ...
    def set_main_settings(self, request_note):
        ...
        self.reviewers_name = request_note.content.get('reviewer_role_name', request_note.content.get('reviewers_name', {})).get('value', 'Reviewers')
        ...
        if request_note.content.get('area_chairs_support',{}).get('value'):
            self.area_chairs_name = request_note.content.get('area_chair_role_name', request_note.content.get('area_chairs_name', {})).get('value', 'Area_Chairs')
