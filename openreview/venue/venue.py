    ...
    def send_decision_notifications(self, decision_options, messages):
        ...
        def send_notification(note):
            ...
            if decision_note and not self.client.get_messages(subject=subject):
                ...
                self.client.post_message(subject, recipients=[self.get_authors_id(note.number)], message=final_message, replyTo=self.contact, invitation=self.get_meta_invitation_id(), signature=self.venue_id)
