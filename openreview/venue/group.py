...
class GroupBuilder(object):
    ...
    def create_venue_group(self, partial_submission_venue_id=None):
        ...
        content = {
            ...
            'withdrawn_venue_id': { 'value': self.venue.get_withdrawn_submission_venue_id(partial_submission_venue_id) },
            'desk_rejected_venue_id': { 'value': self.venue.get_desk_rejected_submission_venue_id(partial_submission_venue_id) },
