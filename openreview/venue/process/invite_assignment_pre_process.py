def process(client, edge, invitation):
    ...
    if edge.ddate is None and edge.label == invite_label:
        ...
        user_profile=openreview.tools.get_profiles(client, [user], with_publications=True, with_relations=True, with_preferred_emails=domain.content.get('preferred_emails_id', {}).get('value'))[0]
