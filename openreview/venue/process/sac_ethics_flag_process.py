    ...
    if flag_note.content['ethics_review_flag']['value'] == 'Yes':
        ...
        if ethics_chairs:
            for chair in ethics_chairs:
                user_profile=openreview.tools.get_profiles(client, [chair], with_publications=True, with_relations=True, with_preferred_emails=domain.content.get('preferred_emails_id', {}).get('value'))[0]
