def process(client, edit, invitation):
    ...
    email_pcs = invitation.content.get('email_pcs', {}).get('value', domain.get_content_value('submission_email_pcs'))
    email_authors = invitation.content.get('email_authors', {}).get('value', True)
