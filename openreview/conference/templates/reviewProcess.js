function(){
    ...
    forumNote.then(function(result) {
      ...
      if (note.readers.includes(PAPER_AREACHAIRS)) {
        var areachair_mail = {
      ...
      if (note.readers.includes(PAPER_AUTHORS)) {
        var author_mail = {
      ...
      promises.push(or3client.addGroupMember(PAPER_REVIEWERS + '/Submitted', note.signatures[0], token));
