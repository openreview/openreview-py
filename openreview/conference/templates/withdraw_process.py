def process(client, note, invitation):
    ...
    forum_note.content = {
        '_bibtex': openreview.tools.get_bibtex(note = original_note if original_note else forum_note, venue_fullname = CONFERENCE_NAME, url_forum = forum_note.id year = CONFERENCE_YEAR, anonymous = not(REVEAL_AUTHORS_ON_WITHDRAW), baseurl = 'https://openreview.net')
    }
