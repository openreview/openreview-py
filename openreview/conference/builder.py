...
class MetaReviewStage(object):
    ...
    def __init__(self, start_date = None, due_date = None, public = False, release_to_authors = False, release_to_reviewers = Readers.NO_REVIEWERS, additional_fields = {}, remove_fields=[], process = None):
        self.start_date = start_date
        self.due_date = due_date
...
class ConferenceBuilder(object):
    ...
    def set_meta_review_stage(self, start_date = None, due_date = None, public = False, release_to_authors = False, release_to_reviewers = MetaReviewStage.Readers.NO_REVIEWERS, additional_fields = {}, remove_fields = [], process = None):
        self.meta_review_stage = MetaReviewStage(start_date, due_date, public, release_to_authors, release_to_reviewers, additional_fields, remove_fields, process)
