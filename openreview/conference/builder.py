...
class Conference(object):
    ...
    def setup_matching(self, committee_id=None, affinity_score_file=None, tpms_score_file=None, elmo_score_file=None, build_conflicts=None, alternate_matching_group=None, scores_stream=None):
        ...
        return conference_matching.setup(affinity_score_file, tpms_score_file, elmo_score_file, build_conflicts, scores_stream)
