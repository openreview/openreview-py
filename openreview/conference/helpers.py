...
def get_conference_builder(client, request_form_id, support_user='OpenReview.net/Support'):
    ...
    withdraw_submission_due_date = note.content.get('withdraw_submission_deadline')
    if withdraw_submission_due_date:
        try:
            withdraw_submission_due_date = datetime.datetime.strptime(withdraw_submission_due_date, '%Y/%m/%d %H:%M')
        except ValueError:
            withdraw_submission_due_date = datetime.datetime.strptime(withdraw_submission_due_date, '%Y/%m/%d')
    ...
    builder.set_submission_stage(
        ...
        withdraw_submission_due_date=withdraw_submission_due_date,
