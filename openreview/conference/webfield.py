...
class WebfieldBuilder(object):
    ...
    def set_expertise_bid_page(self, conference, invitation):
        ...
        header = self.__build_options(default_header, conference.get_expertise_bidpage_header())
        ...
        with open(os.path.join(os.path.dirname(__file__), 'templates/expertiseBidWebfield.js')) as f:
            ...
            content = content.replace("var EXPERTISE_BID_ID = '';", "var EXPERTISE_BID_ID = '" + conference.get_expertise_bid_id() + "';")
