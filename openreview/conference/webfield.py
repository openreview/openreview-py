...
class WebfieldBuilder(object):
    ...
    def set_bid_page(self, conference, invitation, stage):
        ...
        with open(os.path.join(os.path.dirname(__file__), template)) as f:
            ...
            if stage.max_submission_count is not None:
                content = content.replace("var MAX_SUBMISSION_COUNT = Infinity;", "var MAX_SUBMISSION_COUNT = " + str(stage.max_submission_count) + ";")
