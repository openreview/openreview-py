...
OpenReview Team'''
            response = client.post_message(journal.get_meta_invitation_id(), subject, [edge.tail], message, venue_id, replyTo=journal.contact_info)
...
OpenReview Team'''
            ...
            ## - Send email
            response = client.post_message(journal.get_meta_invitation_id(), subject, edge.signatures, message, venue_id, replyTo=journal.contact_info)
            return
