...
{inviter_preferred_name}'''
        ...
        ## - Send email
        response = client.post_message(journal.get_meta_invitation_id(), subject, [user_profile.id], message, journal.venue_id, replyTo=inviter_profile.get_preferred_name())
