...
class GroupBuilder(object):
    ...
    def set_groups(self, journal, support_role, editors):
        ...
        with open(os.path.join(os.path.dirname(__file__), 'webfield/editorsInChiefWebfield.js')) as f:
            ...
            content = content.replace("var SUBMITTED_STATUS = '';", "var SUBMITTED_STATUS = '" + journal.submitted_venue_id + "';")
            content = content.replace("var UNDER_REVIEW_STATUS = '';", "var UNDER_REVIEW_STATUS = '" + journal.under_review_venue_id + "';")
            content = content.replace("var DESK_REJECTED_STATUS = '';", "var DESK_REJECTED_STATUS = '" + journal.desk_rejected_venue_id + "';")
            content = content.replace("var WITHDRAWN_STATUS = '';", "var WITHDRAWN_STATUS = '" + journal.withdrawn_venue_id + "';")
            content = content.replace("var REJECTED_STATUS = '';", "var REJECTED_STATUS = '" + journal.rejected_venue_id + "';")
            content = content.replace("var ACCEPTED_STATUS = '';", "var ACCEPTED_STATUS = '" + journal.accepted_venue_id + "';")
            content = content.replace("var RETRACTED_STATUS = '';", "var RETRACTED_STATUS = '" + journal.retracted_venue_id + "';")
