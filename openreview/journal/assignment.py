...
class Assignment(object):
    ...
    def setup_ae_assignment(self, note):
        ...
        for action_editor_profile in tqdm(action_editor_profiles):
            ...
            conflicts = tools.get_conflicts(self.client, author_profiles, action_editor_profile, policy='NeurIPS', n_years=3)
            if conflicts:
    ...
    def setup_reviewer_assignment(self, note, job_id=None):
        ...
        for reviewer_profile in tqdm(reviewer_profiles):
            ...
            conflicts = tools.get_conflicts(self.client, author_profiles, reviewer_profile, policy='NeurIPS', n_years=3)
            if conflicts:
    ...
    def compute_conflicts(self, note, reviewer):
        ...
        return tools.get_conflicts(self.client, author_profiles, reviewer_profiles[0], policy='NeurIPS')
