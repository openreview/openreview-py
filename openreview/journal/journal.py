...
class Journal(object):
    ...
    def __init__(self, client, venue_id, secret_key, contact_info, full_name, short_name, website='jmlr.org/tmlr', submission_name='Author_Submission'):
        ...
        self.submitted_venue_id = f'Submitted to {venue_id}'
        self.under_review_venue_id = f'Under review for {venue_id}'
        self.rejected_venue_id = f'Rejected by {venue_id}'
        self.desk_rejected_venue_id = f'Desk rejected by {venue_id}'
        self.withdrawn_venue_id = 'Withdrawn by Authors'
        self.retracted_venue_id = 'Retracted by Authors'
        self.accepted_venue_id = f'Accepted by {venue_id}'
